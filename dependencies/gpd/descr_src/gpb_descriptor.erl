...
-export_type(['SourceCodeInfo.Location'/0, 'DescriptorProto.ReservedRange'/0, 'UninterpretedOption.NamePart'/0, 'UninterpretedOption'/0, 'ServiceOptions'/0, 'MethodOptions'/0, 'MethodDescriptorProto'/0, 'ServiceDescriptorProto'/0, 'SourceCodeInfo'/0, 'EnumValueOptions'/0, 'EnumValueDescriptorProto'/0, 'FileOptions'/0, 'FieldOptions'/0, 'FieldDescriptorProto'/0, 'EnumOptions'/0, 'EnumDescriptorProto'/0, 'MessageOptions'/0, 'OneofDescriptorProto'/0, 'DescriptorProto.ExtensionRange'/0, 'DescriptorProto'/0, 'FileDescriptorProto'/0, 'FileDescriptorSet'/0, 'GeneratedCodeInfo.Annotation'/0, 'GeneratedCodeInfo'/0]).

-spec encode_msg(#'SourceCodeInfo.Location'{} | #'DescriptorProto.ReservedRange'{} | #'UninterpretedOption.NamePart'{} | #'UninterpretedOption'{} | #'ServiceOptions'{} | #'MethodOptions'{} | #'MethodDescriptorProto'{} | #'ServiceDescriptorProto'{} | #'SourceCodeInfo'{} | #'EnumValueOptions'{} | #'EnumValueDescriptorProto'{} | #'FileOptions'{} | #'FieldOptions'{} | #'FieldDescriptorProto'{} | #'EnumOptions'{} | #'EnumDescriptorProto'{} | #'MessageOptions'{} | #'OneofDescriptorProto'{} | #'DescriptorProto.ExtensionRange'{} | #'DescriptorProto'{} | #'FileDescriptorProto'{} | #'FileDescriptorSet'{} | #'GeneratedCodeInfo.Annotation'{} | #'GeneratedCodeInfo'{}) -> binary().
...
get_msg_names() ->
    ['SourceCodeInfo.Location',
     ...
     'SourceCodeInfo', 'EnumValueOptions',
     'EnumValueDescriptorProto', 'FileOptions',
     'FieldOptions', 'FieldDescriptorProto', 'EnumOptions',
     'EnumDescriptorProto', 'MessageOptions',
     'OneofDescriptorProto',
